...
\ref{sec:IstAnalyse}: \nameref{sec:IstAnalyse} genannten Excel-Tabelle, so gut
...
ein pauschaler Stundenlohn von \eur{25} angenommen. Daraus ergibt sich eine
Kostenaufstellung, die sich in Tabelle~\ref{tab:Kostenaufstellung}:
\nameref{tab:Kostenaufstellung} befindet. Die Gesamtkosten belaufen sich damit
auf \eur{1687,50}.
