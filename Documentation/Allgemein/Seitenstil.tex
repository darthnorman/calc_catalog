...
\geometry{a4paper,left=30mm,right=40mm,top=20mm,bottom=30mm}
...
%\setheadwidth[0pt]{textwithmarginpar} % Kopfzeile über den Text hinaus
% verbreitern (falls Logo den Text überdeckt)
