...
<form class="form-horizontal" action="/?controller=category&action=add&id=<?php echo $category->id ?>" method="POST">
	...
	<div class="form-group">
		<label class="col-sm-3 col-lg-2 control-label" for="categoryName">Bezeichnung</label>
		<div class="col-sm-8 col-lg-6">
			<input id="categoryName" name="name" class="form-control" type="text" value="<?php echo $category->name ?>" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 col-lg-2 control-label" for="categoryTaxrate">Kalkulationspositionen (<?php echo $category->getItemCount($category->id) ?>)</label>
		<div class="col-sm-5 col-lg-3">
			<select id="categoryItems" name="items" class="form-control" readonly size="10">
			<?php 
