...
<form class="form-horizontal" action="/?controller=customer&action=show&id=<?php echo $customer->id ?>" method="POST">
	...
	<div class="form-group">
		...
		<div class="col-sm-8 col-lg-6">
			<input id="customerName" name="name" class="form-control" type="text" value="<?php echo $customer->name ?>" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 col-lg-2 control-label" for="customerAddress">Adresse</label>
		<div class="col-sm-8 col-lg-6">
			<input id="customerAddress" name="address" class="form-control" type="text" value="<?php echo $customer->address ?>" />
		</div>
	</div>
	<hr>
	<div class="form-group">
