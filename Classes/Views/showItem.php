...
<form class="form-horizontal" action="/?controller=item&action=show&id=<?php echo $item->id ?>" method="POST">
	...
	<div class="form-group">
		<label class="col-sm-3 col-lg-2 control-label" for="itemName">Positionsname</label>
		<div class="col-sm-8 col-lg-6">
			<input id="itemName" name="name" class="form-control" type="text" value="<?php echo $item->name ?>" />
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 col-lg-2 control-label" for="itemDescription">Beschreibung</label>
		<div class="col-sm-8 col-lg-6">
			<textarea id="itemDescription" name="description" class="form-control" rows="5"><?php echo $item->description ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 col-lg-2 control-label" for="itemTmin">min. Aufwand</label>
	...
	<div class="form-group">
		<label class="col-sm-3 col-lg-2 control-label" for="itemTmax">max. Aufwand</label>
		<div class="col-sm-5 col-lg-3">
			<div class="input-group">
	...
	<div class="form-group">
		<label class="col-sm-3 col-lg-2 control-label" for="itemCategory">Kategorie</label>
		<div class="col-sm-5 col-lg-3">
